...
class Product extends TableBase {
  ...
  Product.withFields(this.name, this.quantity, this.selling_price,
      this.cost_price, this.imageUrl, this.isDeleted) {
    _setDefaultValues();
  }
  Product.withId(this.id, this.name, this.quantity, this.selling_price,
      this.cost_price, this.imageUrl, this.isDeleted) {
    _setDefaultValues();
  }
  // fromMap v2.0
  ...
  @override
  List<dynamic> toArgs() {
    return [name, quantity, selling_price, cost_price, imageUrl, isDeleted];
  }

  @override
  List<dynamic> toArgsWithIds() {
    return [id, name, quantity, selling_price, cost_price, imageUrl, isDeleted];
  }
  ...
  Future<int?> upsert({bool ignoreBatch = true}) async {
    try {
      final result = await _mnProduct.rawInsert(
          'INSERT OR REPLACE INTO products (id, name, quantity, selling_price, cost_price, imageUrl,isDeleted)  VALUES (?,?,?,?,?,?,?)',
          [id, name, quantity, selling_price, cost_price, imageUrl, isDeleted],
          ignoreBatch);
      if (result! > 0) {
