...
abstract class $CustomResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({dynamic message, dynamic status});
}
...
class __$$_CustomResponseCopyWithImpl<$Res>
    extends _$CustomResponseCopyWithImpl<$Res, _$_CustomResponse>
...
/// @nodoc
@JsonSerializable()
class _$_CustomResponse implements _CustomResponse {
  const _$_CustomResponse({required this.message, required this.status});
  ...
  @override
  String toString() {
    return 'CustomResponse(message: $message, status: $status)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$_CustomResponseToJson(
      this,
    );
  }
}
...
abstract class _CustomResponse implements CustomResponse {
  const factory _CustomResponse(
      ...
      required final dynamic status}) = _$_CustomResponse;
